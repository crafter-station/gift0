    ...
    const fetchGithubStars = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/crafter-station/gift0"
        );
        if (response.ok) {
  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="github-badge fixed top-6 right-4 md:top-5 md:right-6 z-50 flex items-center gap-2.5 px-4 py-2 md:px-5 md:py-2.5 bg-black/40 backdrop-blur-sm border border-white/10 rounded-md opacity-60 hover:opacity-100 transition-opacity duration-300 group"
